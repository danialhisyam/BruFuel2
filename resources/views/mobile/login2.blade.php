...
new class extends Component {
    ...
    public function login(): void
    {
        ...
        $this->redirect(route('mobile.home', absolute: false), navigate: true);
    }
};
?>
  ...
  <div class="right-side">
    ...
    <div class="form-wrapper">
      <div class="text-center mb-6">
        <img src="{{ asset('images/Logook.png') }}" class="mx-auto w-20 h-20 object-contain mb-3" alt="BruFuel Logo" style="filter: drop-shadow(0 0 10px rgba(37, 99, 235, 0.5));">
      </div>
      <h2>Welcome Back</h2>
