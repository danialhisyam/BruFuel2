...
style="background: none; border: none; padding: 0; position: absolute; left: 371.85px; top: 82.97px; width: 40px; height: 40px; cursor: pointer; transition: transform 0.15s ease; outline: none; -webkit-tap-highlight-color: transparent; z-index: 10;"
onmousedown="this.style.transform='scale(1.2)'"
onmouseup="this.style.transform='scale(1)'"
ontouchstart="this.style.transform='scale(1.2)'"
ontouchend="this.style.transform='scale(1)'">
  <img src="{{ asset('images/hafizhensem.png') }}" alt="Login Button" draggable="false" style="width: 100%; height: 100%; display: block;"/>
</button>
...
<div id="tab2" style="display:none; position:relative;">
  ...
  <!-- ✅ Login button -->
<button
  onclick="window.location.href='dashboardlogged.blade.php'"
  style="background:none; border:none; padding:0;
